...
class AddSeriesExam extends ConsumerStatefulWidget {
  const AddSeriesExam({Key? key}) : super(key: key);

  @override
  ConsumerState<AddSeriesExam> createState() =>
      _AddSeriesExamState();
}

class _AddSeriesExamState
    extends ConsumerState<AddSeriesExam> {
  @override
  Widget build(
