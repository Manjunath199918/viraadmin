...
class PendingHomeWork extends ConsumerWidget {
  int? index;
  PendingHomeWork({Key? key, this.index}) : super(key: key);
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          InkWell(
            onTap: () async {
              stateController.getDate(context, currentTheme);
            },
            child: Padding(
                                ...
                                child: Row(
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        Container(
                                            width: 210.toAutoScaledWidth,
                                            child: Text(
                                              'Exercise Trigonometry 1st Topic Topic   ',
                                        ...
                                        Text(
                                          'English',
                                          style:
                                              kTextStyles.s12GreyVariantRegular,
                                        )
                                      ],
                                    ),
                                    KImage(
                                        imageUrl: 'assets/profile/img_2.png',
                                        width: 25.toAutoScaledWidth,
